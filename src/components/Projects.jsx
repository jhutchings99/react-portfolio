...
export default function Projects() {
  return (
    <div id="projects">
      <h2
        id="timeline"
        className="bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-100 text-4xl font-bold text-center pb-8"
      >
        Projects
      </h2>
      <Project
        projectName="Munchy"
        projectDescription="Munchy is a social media web application built using the MERN 
            stack and provides users with a place to share and discover recipes. It has a user-friendly interface 
            that allows users to search for a specific recipe, create a recipe, follow and unfollow users, and interact with
            recipes that you find."
        projectImageLink="https://i.imgur.com/QAf9d66.png"
        projectSourceLink="https://github.com/jhutchings99/munchy"
        projectDemoLink="https://main--whimsical-sherbet-0f678c.netlify.app/"
      />
      <Project
        projectName="Go Gas"
      ...
      />
      <Project
        projectName="Fractal Image Generator"
